var OneTrustStub = (t => {
    ...
    var i, a, o, p = new function() {
        ...
        s = ((b = i = i || {})[b.Days = 1] = "Days", b[b.Weeks = 7] = "Weeks", b[b.Months = 30] = "Months", b[b.Years = 365] = "Years", (b = g = g || {}).GDPR = "GDPR", b.CCPA = "CCPA", b.IAB2 = "IAB2", b.IAB2V2 = "IAB2V2", b.GENERIC = "GENERIC", b.LGPD = "LGPD", b.GENERIC_PROMPT = "GENERIC_PROMPT", b.CPRA = "CPRA", b.CDPA = "CDPA", b.DELAWARE = "DELAWARE", b.IOWA = "IOWA", b.NEBRASKA = "NEBRASKA", b.USNATIONAL = "USNATIONAL", b.CUSTOM = "CUSTOM", b.FLORIDA = "FLORIDA", b.COLORADO = "COLORADO", b.CONNECTICUT = "CTDPA", b.MONTANA = "MONTANA", b.TEXAS = "TEXAS", b.OREGON = "OREGON", b.TENNESSEE = "TENNESSEE", b.NEWJERSEY = "NEWJERSEY", b.NEWHAMPSHIRE = "NEWHAMPSHIRE", b.UCPA = "UCPA", b.VIRGINIA = "VIRGINIA", g.CPRA, g.CDPA, g.COLORADO, g.OREGON, g.CONNECTICUT, g.FLORIDA, g.MONTANA, g.TEXAS, g.DELAWARE, g.IOWA, g.NEBRASKA, g.TENNESSEE, g.NEWJERSEY, g.NEWHAMPSHIRE, g.UCPA, (b = v = v || {}).Name = "OTGPPConsent", b[b.ChunkSize = 4e3] = "ChunkSize", b.ChunkCountParam = "GPPCookiesCount", b.gppSid = "gppSid", (g = a = a || {}).CPRA = "usca", g.CCPA = "usca", g.CDPA = "usva", g.OREGON = "usor", g.USNATIONAL = "usnat", g.COLORADO = "usco", g.FLORIDA = "usfl", g.CTDPA = "usct", g.MONTANA = "usmt", g.TEXAS = "ustx", g.DELAWARE = "usde", g.IOWA = "usia", g.NEBRASKA = "usne", g.TENNESSEE = "ustn", g.NEWJERSEY = "usnj", g.NEWHAMPSHIRE = "usnh", g.UCPA = "usut", g.VIRGINIA = "usva", g.IAB2V2 = "tcfeuv2", (b = o = o || {})[b.CPRA = 8] = "CPRA", b[b.CCPA = 8] = "CCPA", b[b.CDPA = 9] = "CDPA", b[b.OREGON = 15] = "OREGON", b[b.USNATIONAL = 7] = "USNATIONAL", b[b.COLORADO = 10] = "COLORADO", b[b.FLORIDA = 13] = "FLORIDA", b[b.MONTANA = 14] = "MONTANA", b[b.TEXAS = 16] = "TEXAS", b[b.DELAWARE = 17] = "DELAWARE", b[b.IOWA = 18] = "IOWA", b[b.NEBRASKA = 19] = "NEBRASKA", b[b.NEWHAMPSHIRE = 20] = "NEWHAMPSHIRE", b[b.NEWJERSEY = 21] = "NEWJERSEY", b[b.TENNESSEE = 22] = "TENNESSEE", b[b.UCPA = 11] = "UCPA", b[b.VIRGINIA = 9] = "VIRGINIA", b[b.CTDPA = 12] = "CTDPA", b[b.IAB2V2 = 2] = "IAB2V2", "geo"),
        r = "otpreview",
        n = (v.Name, "LOCAL"),
        l = "PRODUCTION",
        c = (0, i.Days, i.Weeks, i.Months, i.Years, d.prototype.camelize = function(t) {
            return (t = t.replace("--", "")).split("-").map(function(t, e) {
                var i = t ? t[0].toUpperCase() + t.slice(1) : "";
                return 0 === e ? t : i
            }).join("")
        }, d.prototype.strToObj = function(t) {
    ...
    function d() {
        ...
        this.implementThePolyfill = function() {
            ...
            return Element.prototype.setAttribute = function(t, e) {
                if ("style" !== ("string" == typeof t ? t.toLowerCase() : "")) o.apply(this, [t, e]);
                else if (null == this.style) o.apply(this, [t, e]);
                else if (e) {
    ...
    }(g = m = m || {}).ping = "ping", g.addEventListener = "addEventListener", g.removeEventListener = "removeEventListener", g.hasSection = "hasSection", g.getSection = "getSection", g.getField = "getField", g.getGPPData = "getGPPData";
    var m, g, f = new function() {
            var s = this;
            this.LOCATOR_NAME = "__gppLocator", this.win = window, this.customInit = "CUSTOMINIT", this.init = function() {
                ...
                switch (n) {
                    ...
                    case m.addEventListener:
                        return s.addEventListener(a, o);
                    case m.removeEventListener:
                ...
                e && e.__gppCall && (n = e.__gppCall, (0, s.win.__gpp)(n.command, function(t, e) {
                    ...
                    i && i.source && i.source.postMessage && (e = (t => {
                        if ("string" != typeof t || !t || "null" === t) return !1;
                        try {
                            return new URL(t).origin === t
                        } catch (t) {
                            return !1
                        }
                    })(i.origin) ? i.origin : "*", i.source.postMessage(a ? JSON.stringify(t) : t, e))
                }, n.parameter))
    ...
    S.prototype.initConsentSDK = function() {
        ...
        e && e.CookieV2BulkDomainManagement && i !== n && t.ScriptType === l && ((e = window.sessionStorage) && e.getItem("bulkDomainMgmtEnabled") ? this.handleBulkDomainMgmt({
        ...
        if (this.setDomainIfBulkDomainEnabled(t), this.updateVersion(t), this.subDomainEnabled = t.SubDomainEnabled || !1, this.domainHashValue = t.DomainHashValue || "", this.scriptType = t.ScriptType || "", this.ensureHtmlGroupDataInitialised(), (t.TenantFeatures && t.TenantFeatures.CookieV2CSP || t.CookieV2CSPEnabled) && this.nonce && (this.setAttributePolyfillIsActive = !0, (new c).implementThePolyfill()), A.checkAndAssignCspTrustedTypeEnabled(t) && A.initCSPTrustedType(p.storageBaseURL), !t.RuleSet[0].Type) return this.iabTypeAdded = !1, window.__tcfapi = this.executeTcfApi, this.intializeIabStub(), this.addBannerSDKScript(t);
        var e, i = window;
        ...
        return (this.scriptType === l || this.scriptType === n) && this.subDomainEnabled && this.domainHashValue ? "_" + this.domainHashValue : ""
        ...
        "debug" !== this.buildType && "cybuild" !== this.buildType || (t.Version = "202609.1.0")
    };
    var b = S;
    ...
    function S() {
        ...
        this.iabType = null, this.iabTypeAdded = !0, this.crossOrigin = null, this.isAmp = !1, this.domainId = "", this.isReset = !1, this.isPreview = !1, this.geoFromUrl = "", this.nonce = "", this.setAttributePolyfillIsActive = !1, this.storageBaseURL = "", this.charset = null, this.isShopify = !1, this.isBotHeaderDomain = !1, this.subDomainEnabled = !1, this.domainHashValue = "", this.scriptType = "", this.buildType = "undefined", this.addBannerSDKScript = function(s) {
            ...
            h(n, "display: none;", !0), n.name = t, n.setAttribute("title", e + " Locator"), i.document.body.appendChild(n)
